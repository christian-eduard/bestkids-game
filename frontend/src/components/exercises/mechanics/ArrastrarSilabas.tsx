    ...
    return (
        <DndContext onDragEnd={handleDragEnd}>
            <div className="flex flex-col items-center w-full max-w-5xl mx-auto p-6 space-y-12">
                <div className="bg-white p-6 rounded-3xl shadow-sm border-2 border-purple-50 flex items-center gap-4">
                    <h2 className="text-2xl font-black text-gray-700 uppercase tracking-tight">{exercise.instruction}</h2>
                </div>
