...
export default function TecladoVirtual({ exercise, onAnswer, embedded = false, onAnswerChange }: Props) {
    ...
    React.useEffect(() => {
        if (embedded && onAnswerChange) {
            onAnswerChange(inputValue ? inputValue : null);
        }
    }, [inputValue, embedded, onAnswerChange]);
