...
INSERT INTO exercises (id, subject_area_id, title, description, exercise_type, difficulty_level, content, correct_answer, points, is_active, created_by) VALUES
(1, 1, 'Suma Básica', 'Resuelve la operación', 'multiple_choice', 'easy', '{"question":"¿Cuánto es 15 + 27?","options":["32","42","52"]}', '{"answer":"42"}', 10, true, 3),
(2, 2, 'Colores en Inglés', 'Elige el color correcto', 'multiple_choice', 'easy', '{"question":"What color is the sky?","options":["Green","Red","Blue"]}', '{"answer":"Blue"}', 10, true, 3);

-- Type: true_false
INSERT INTO exercises (id, subject_area_id, title, description, exercise_type, difficulty_level, content, correct_answer, points, is_active, created_by) VALUES
(3, 3, 'Gravedad Lunar', 'Hechos espaciales', 'true_false', 'easy', '{"question":"La luna tiene gravedad"}', '{"answer": true}', 10, true, 3),
(4, 1, 'Números Primos', 'Verifica la propiedad', 'true_false', 'medium', '{"question":"El número 1 es un número primo"}', '{"answer": false}', 15, true, 3);

-- Type: matching (Fixed content keys for MatchingExercise.tsx)
-- Component wants: leftColumn, rightColumn, correctPairs
INSERT INTO exercises (id, subject_area_id, title, description, exercise_type, difficulty_level, content, correct_answer, points, is_active, created_by) VALUES
(5, 2, 'Parejas de Animales', 'Une el español con el inglés', 'matching', 'easy', '{"question":"Une los animales","leftColumn":[{"id":"L1","text":"Perro"},{"id":"L2","text":"Gato"}],"rightColumn":[{"id":"R1","text":"Dog"},{"id":"R2","text":"Cat"}],"correctPairs":[{"left":"L1","right":"R1"},{"left":"L2","right":"R2"}]}', '[{"left":"L1","right":"R1"},{"left":"L2","right":"R2"}]', 20, true, 3),
(6, 1, 'Resultados Rápidos', 'Une la operación con su resultado', 'matching', 'medium', '{"question":"Une la operación","leftColumn":[{"id":"L1","text":"5 + 5"},{"id":"L2","text":"2 x 2"}],"rightColumn":[{"id":"R1","text":"10"},{"id":"R2","text":"4"}],"correctPairs":[{"left":"L1","right":"R1"},{"left":"L2","right":"R2"}]}', '[{"left":"L1","right":"R1"},{"left":"L2","right":"R2"}]', 20, true, 3);

-- Type: fill_blanks
-- Component wants: text with {id}, blanks array with id/correctAnswers
INSERT INTO exercises (id, subject_area_id, title, description, exercise_type, difficulty_level, content, correct_answer, points, is_active, created_by) VALUES
(7, 1, 'Secuencias Numéricas', 'Rellena el hueco', 'fill_blanks', 'easy', '{"question":"Completa la serie","text":"2, 4, {0}, 8","blanks":[{"id":"0","correctAnswers":["6"]}]}', '{"0":"6"}', 15, true, 3),
(8, 2, 'Gramática Básica', 'Completa la frase', 'fill_blanks', 'medium', '{"question":"Completa la frase","text":"I {0} a student.","blanks":[{"id":"0","correctAnswers":["am"]}]}', '{"0":"am"}', 15, true, 3);

-- Type: sequence
-- Component wants: items with id/text/order
INSERT INTO exercises (id, subject_area_id, title, description, exercise_type, difficulty_level, content, correct_answer, points, is_active, created_by) VALUES
(9, 1, 'Orden Numérico', 'Ordena de menor a mayor', 'sequence', 'easy', '{"question":"Ordena los números","items":[{"id":"1","text":"15","order":1},{"id":"2","text":"25","order":2},{"id":"3","text":"35","order":3}]}', '["1","2","3"]', 15, true, 3),
(10, 3, 'Ciclo de Vida', 'Ordena las etapas', 'sequence', 'medium', '{"question":"Ciclo de la mariposa","items":[{"id":"1","text":"Huevo","order":1},{"id":"2","text":"Oruga","order":2},{"id":"3","text":"Mariposa","order":3}]}', '["1","2","3"]', 25, true, 3);

-- Type: multi_select
-- Component wants: question, options
INSERT INTO exercises (id, subject_area_id, title, description, exercise_type, difficulty_level, content, correct_answer, points, is_active, created_by) VALUES
(11, 3, 'Mamíferos Marinos', 'Selecciona todos los que sean mamíferos', 'multi_select', 'medium', '{"question":"¿Cuáles son mamíferos?","options":["Ballena","Delfín","Tiburón"]}', '["Ballena","Delfín"]', 20, true, 3),
(12, 1, 'Números Pares', 'Selecciona los números pares', 'multi_select', 'easy', '{"question":"¿Cuáles son pares?","options":["2","7","14"]}', '["2","14"]', 15, true, 3);

-- Type: drag_drop (Similar to sequence but with words/items key)
-- Component wants: words array with id/text
INSERT INTO exercises (id, subject_area_id, title, description, exercise_type, difficulty_level, content, correct_answer, points, is_active, created_by) VALUES
(13, 2, 'Canasta de Frutas', 'Arrastra las frutas a su lugar', 'drag_drop', 'easy', '{"question":"Ordena las frutas","words":[{"id":"1","text":"Manzana"},{"id":"2","text":"Plátano"}],"correctSequence":["1","2"]}', '["1","2"]', 15, true, 3),
(14, 3, 'Anatomía Humana', 'Coloca los órganos en su sitio', 'drag_drop', 'hard', '{"question":"Órganos principales","words":[{"id":"1","text":"Cerebro"},{"id":"2","text":"Corazón"}],"correctSequence":["1","2"]}', '["1","2"]', 30, true, 3);

-- 11. LEVEL EXERCISES (Link to world levels)
...
('Poción de Sabiduría', 'powerup', 50, 'Duplica los puntos por 30 min', 1, 'https://images.unsplash.com/photo-1599408162172-fe5bdf5fcbbd?w=100&h=100&fit=crop'),
('Escudo Anti-Error', 'powerup', 100, 'Protege tu racha de una respuesta incorrecta', 1, 'https://images.unsplash.com/photo-1598921821422-487625be2864?w=100&h=100&fit=crop');
...
SELECT u.id, (SELECT id FROM store_items LIMIT 1), NOW()
FROM users u
WHERE u.role_id = 5;
